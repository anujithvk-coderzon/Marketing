...
var redisUrl = new URL(process.env.REDIS);
var connection = {
...
var scheduleCampaignJob = function (campaignId, scheduledAt) {
    return __awaiter(this, void 0, void 0, function () {
        var existingJob, delay;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, exports.campaignQueue.getJob(campaignId)];
                case 1:
                    existingJob = _a.sent();
                    if (!existingJob) return [3 /*break*/, 3];
                    return [4 /*yield*/, existingJob.remove()];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
                    delay = Math.max(0, new Date(scheduledAt).getTime() - Date.now());
                    return [4 /*yield*/, exports.campaignQueue.add('send-campaign', { campaignId: campaignId }, {
                            jobId: campaignId,
                            delay: delay
                        })];
                case 4:
...
var removeCampaignJob = function (campaignId) {
    return __awaiter(this, void 0, void 0, function () {
        var existingJob;
        return __generator(this, function (_a) {
            switch (_a.label) {
